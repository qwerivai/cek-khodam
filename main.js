...
// DESK KHODAM
            if ( random == 0 ) {
                $('#desk').html("Beat karbu adalah khodam yang sangat di idamkan oleh kebanyakan orang apalagi orang tersebut sangat suka night ride (NR). Selain bisa menjaga diri kita, khodam Beat karbu ini juga bisa menghindarirazia malam karena bisa mempercepat laju kendaraan.")
            } else if ( random == 1 ) {
                ...
                $('#desk').html("Banaspati introvert adalah khodam yang sangat overpower hanya saja terdapat kelemahan dengan khodam ini, yaitu tidak ingin keluar rumah. Khodam ini sangat cenderung lebih memilih didalam kamar dan khodam ini sangat suka nonton animek.")
            } else if ( random === 8 ) {
                ...
                $('#desk').html("Miniatur genderuwo adalah jenis khodam yang sangat tidak berguna, selain ukurannya yang sangat kecil khodam inipun hanya dijadikan bahan tertawaan anak-anak, jadi jika kamu punya khodam ini segera lapor dukun terdekat untuk segera dibersihkan.")
            } else if ( random === 11 ) {
